...
const TOOLS: Tool[] = [
    ...
    inputSchema: {
      ...
      properties: {
        ...
        hints: {
          type: "object",
          description:
            "Optional partial knowledge to improve suggestions (e.g., { 'scope.program': 'anvil-forge-vault', 'scope.repo': 'anvil' })",
        },
      },
      required: ["content"],
    },
  ...
  },
  {
    ...
    description:
      "Retrieve the full schema definition and all registry contents (tags, repos, " +
      "programs). Use this to understand available page types, field constraints, and " +
  ...
  },
  {
    ...
    description:
      "Add a new entry to a registry (tags, repos, or programs). Use this when " +
